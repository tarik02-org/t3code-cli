...
t3cli thread update [--thread <id>] [--title <title>] [--provider <provider>] [--model <model>] [--option <key=value>] [--reasoning-effort <value>] [--effort <value>] [--fast-mode] [--thinking] [--branch <name>] [--clear-branch] [--worktree <path>] [--clear-worktree]
```
